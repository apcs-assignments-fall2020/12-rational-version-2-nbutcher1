public class Rational
{
    ...
    public boolean isSimplified() { 
        ...
        return this.numerator/gcd == this.denominator;
    }
    ...
    public Rational pow(int exponent) {
        Rational expo = new Rational(0,0);
        expo.numerator = this.numerator * exponent;
        expo.denominator = this.denominator * exponent;
        return expo;
    }
